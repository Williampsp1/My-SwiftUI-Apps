        ...
        ScrollView(showsIndicators: false) {
            VStack(spacing: 20) {
                ...
                VStack(alignment: .leading, spacing: 25) {
                    ...
                    GuideComponent(title: "Book", subtitle: "Tap the button", description: "Our selection of honeymoon resorts are the perfect settings for you to embark your new life together.", icon: "checkmark.square")
                }
